...
const dashboardImprovementsCss = fs.readFileSync(path.join(root, "public", "dashboard-improvements.css"), "utf8");
...
assert.match(html, /rel="icon"[^>]+wellnessbox-logo\.png/);
assert.match(html, /rel="apple-touch-icon"/);
assert.match(html, /rel="manifest" href="\/site\.webmanifest"/);
assert.match(dashboardCss, /\.brand span\{[^}]*width:32px[^}]*height:32px/);
assert.match(dashboardImprovementsCss, /\.company-brand>span\{[^}]*width:auto[^}]*height:auto[^}]*background:transparent/);
