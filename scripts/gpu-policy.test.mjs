...
import { assertGpuEligibleForJob, assertHighValueCloudGpu, gpuCapability, isHighValueCloudGpu } from "../lib/gpu-policy.js";
...
assert.equal(assertGpuEligibleForJob("kakao", "gn1i.xlarge", { preset_id: "qwen-lora-v1", type: "custom-gpu" }).profile, "qlora-4bit");
assert.throws(() => assertGpuEligibleForJob("kakao", "gn1i.xlarge", { preset_id: "other" }), /cloud_gpu_not_better_than_local/);
