...
export async function enableBrowserUploads(bucket) {
  const xml = `<?xml version="1.0" encoding="UTF-8"?><CORSConfiguration><CORSRule><AllowedOrigin>https://cloud-gpu-runner-console.vercel.app</AllowedOrigin><AllowedOrigin>https://work-memory-ten.vercel.app</AllowedOrigin><AllowedMethod>PUT</AllowedMethod><AllowedMethod>GET</AllowedMethod><AllowedHeader>*</AllowedHeader><ExposeHeader>ETag</ExposeHeader><MaxAgeSeconds>3600</MaxAgeSeconds></CORSRule></CORSConfiguration>`;
  await s3Request({
    ...config(),
    method: "PUT",
    path: bucket,
