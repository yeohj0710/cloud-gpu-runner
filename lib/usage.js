...
export function estimateGpu(flavor, minutes, volumeGb = 80) {
  ...
  const objectRequests = STORAGE.naver.get + STORAGE.naver.put;
  return { provider: "kakao", flavor, minutes: Number(minutes) || 0, volume_gb: Number(volumeGb) || 0, gpu, disk, object_requests: objectRequests, total: gpu + disk + objectRequests, currency: "KRW", vat_included: false };
}
