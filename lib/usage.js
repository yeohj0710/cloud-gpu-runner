...
export const CREDIT_EXPIRY = { naver: "2027-04-30", kakao: "2027-05-31" };
export const CREDIT_GRANTS = {
  naver: [
    { amount: 300000, expiresOn: "2026-07-31", name: "Credit Discount to New Customers Plus" },
    { amount: 5000000, expiresOn: "2027-04-30", name: "Greenhouse Track 1 first grant" },
  ],
  kakao: [
    { amount: 10000000, expiresOn: "2027-05-31", name: "Rocket Launcher Boost issued credit" },
  ],
};
